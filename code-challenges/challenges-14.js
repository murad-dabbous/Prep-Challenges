...
const LastWord_2 = (str) => {
  const result = str.trim().split(" ").pop();
  return result;
};
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
  let combineString = str.split(" ");
  for (let i = 0; i < combineString.length; i++) {
    if (combineString[i].indexOf("I") === 0) {
      combineString.splice(i, 1, "We");
    } else if (combineString[i].indexOf("am") === 0) {
      combineString.splice(i, 1, "are");
    } else if (combineString[i].indexOf("was") === 0) {
      combineString.splice(i, 1, "were");
    }
  }
