...
function square(arr) {
  let result = arr.map((arrItem) => arrItem * arrItem);
  return result;
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
  let result = arr.map((item) => item.firstName + " " + item.lastName);
  return result;
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
  let updatedArr = arr.map((studentObj) => ({
    // add the avg peoperty to the existing array of objects
    ...studentObj,
    avg:
      studentObj.gradsList.reduce((a, b) => a + b, 0) /
      studentObj.gradsList.length,
  }));
  return updatedArr;
}
// -------------------------------------------------------------------------------------------------------
