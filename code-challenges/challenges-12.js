...
const oddFiltration = (arr) => {
  const result = arr.filter((arrItem) => arrItem % 2 !== 0);
  return result;
};
// -------------------------------------------------------------------------------------------------------
...
const cvsFiltration = (arr) => {
  const result = arr
    .filter((arrItem) => {
      return arrItem.tech === "JS" && arrItem.yearsOfExperience > 4;
    })
    .map((arrItem) => {
      let fullName =
        arrItem.firstName && arrItem.LastName
          ? arrItem.firstName + " " + arrItem.LastName
          : arrItem.firstName || arrItem.LastName;
      return {
        fullName: fullName,
...
const vowelsFiltration = (arr) => {
  const result = arr.filter((arrItem) => !/[aeiou]/.test(arrItem));
  return result;
};
// -------------------------------------------------------------------------------------------------------
